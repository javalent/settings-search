...
## Important Links for Settings Search

- **[Documentation](https://plugins.javalent.com/settings-search)**
- **[Submit an Issue](https://github.com/javalent/settings-search/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc)**
- **[Bug Tracker](https://github.com/javalent/settings-search/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3Abug)**
